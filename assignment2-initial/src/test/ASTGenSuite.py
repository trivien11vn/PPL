...
\tFuncDecl(main, VoidType, [], None, BlockStmt([CallStmt(printInteger, IntegerLit(4))]))
    ...
    def test102(self):
        ...
        """
        expect = """Program([
	FuncDecl(main, VoidType, [Param(b, AutoType), Param(c, AutoType)], None, BlockStmt([VarDecl(a, StringType, BinExpr(::, Id(b), BinExpr(+, Id(b), Id(c))))]))
])"""
